import { estadosDimension, estadosPersonaje, tiposEspecie, tiposInvento, tipoAfiliacion, tipoLocalizacion, tipoEventoMultiversal, accionEventoDimension, accionEventoInvento } from "../utils/types.js";
